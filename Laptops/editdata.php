    ...
    <form class="form-horizontal" method="post">
        <div class="modal-content">
                ...
                <form class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="col-sm-4 control-label" for="txtveloci">Velocidad</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="txtveloci" name="txtveloci" value="<?php echo $per_Veloci;?>">
                            </div>
                        </div>
                        <div class="form-group">
           ...
           <div class="modal-footer">
                <a href="visualizar_laptops"><button type="button" class="btn btn-danger">Cancelar</button></a>
