...
<html lang="en">
<head>
        <?php include("head.php");?><h1 class="text-info" ><strong><center>Sistema de Inventario Web</center></strong></h1>
 		...
 		<h1 class="text-info" align="left"><strong >INGRESE LOS DATOS</strong></h1>
			<form class="form-horizontal" method="POST" action="Operacion_guardar.php" autocomplete="off">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="nombre" name="codigo" placeholder="Codigo" required>
					</div>
				</div>
...
<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="name" class="form-control" id="email" name="personal" placeholder="Nombre" required>
					</div>
				</div>
