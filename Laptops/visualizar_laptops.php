...
<body> 
    <div class="table-responsive">
        <div align="center">
            <h1 class="text-info" align="center"><strong>LISTA DE LAPTOPS</strong></h1>
       <img  src="../imag/laptop_opt.png" alt="..." align="center" class="img-circle">
...
<form action="Reporte_exel_Laptops">
<div align="center"> 
...
if(isset($_POST['btnEdit'])){
    ...
    $sqlupdate="UPDATE equipos SET Codigo='$new_codigo',
         Marca='$new_marca',Serie='$new_serie',Producto='$new_producto',Ram='$new_ram',Discoduro='$new_discoduro',Sistema='$new_sistema',Arquitectura='$new_arquitectura',Procesador='$new_procesador',Macadd='$new_macadd',Departamento='$new_departamento',Puesto='$new_puesto',Personal='$new_personal',Fecha='$new_fecha',Veloci='$new_veloci'
                WHERE id='$new_id'";
    $result_update=mysqli_query($con,$sqlupdate);
    if($result_update){
        echo '<script>window.location.href="visualizar_laptops"</script>';
    }
    else{
