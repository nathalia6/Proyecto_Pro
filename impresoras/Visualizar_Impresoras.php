...
<body> 
    ...
    <div class="table-responsive">
       <div align="center">
            <h1 class="text-info" align="center"><strong>LISTA DE IMPRESORAS</strong></h1>
       <img  src="../imag/impresora_opt.png" alt="..." align="center" class="img-circle">
        <table id="example" class="table-hover table-bordered" style="font-size: 25;">
            ...
            <tr>
                ...
                <th style="color:ffffff" bgcolor="#154360">Dirección IP</th>
...
<form method="post" action="Reporte_Impresoras" target="_blank">  
<div align="center">
...
<form action="Reporte_exel_Impresoras">
<div align="center"> 
...
if(isset($_POST['btnEdit'])){
    ...
    $new_direccionip=mysqli_real_escape_string($con,$_POST['txtdireccionip']);
 ...
 $sqlupdate="UPDATE impresoras SET Codigo='$new_codigo',
         Marca='$new_marca',Modelo='$new_modelo',Serie='$new_serie',Producto='$new_producto',DireccionIP='$new_direccionip',Departamento='$new_departamento',Puesto='$new_puesto',Personal='$new_personal'
                WHERE id='$new_id'";
    $result_update=mysqli_query($con,$sqlupdate);
    if($result_update){
        echo '<script>window.location.href="Visualizar_Impresoras"</script>';
    }
    else{
...
if(isset($_GET['delete'])){
    $id=$_GET['delete'];
    $sqldelete="DELETE FROM impresoras WHERE id='$id'";
