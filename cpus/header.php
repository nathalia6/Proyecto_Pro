  ...
  color: #B3B6B7 !important;
              ...
              <div class="container-fluid">             
                <div class="navbar-header"  >
                  ...
                  <a class="navbar-brand" href="../index.php">Inventario NOJRC</a>
                </div>
                <div class="collapse navbar-collapse" id="menu">
                  <ul class="navbar-nav">
                
                    <li class="dropdown">
                      <a style="text-decoration:none;" class="dropdown-toggle"><span class="icon-plus"></span> Agregar  <b class="caret"></b></a>
                      <ul class="dropdown-menu">
                        <li><a href="../cpus/agregar">CPU</a></li>
                        <li><a href="../Laptops/agregarlaptop" id="guarda">LAPTOP</a></li>
...
<li class="dropdown">
<?php
echo '<a style="text-decoration:none;" href="../logout" class="dropdown-toggle"><span class="icon-enter"></span>  Logout  </a>';
?>
