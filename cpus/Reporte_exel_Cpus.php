...
header('Content-Disposition: attachment;filename="Reporte_CPUS.xls"');
...
<html>
<head>
	<title>Lista de CPU's</title>
</head>
<body>
	<table width="100%" border="1" cellpadding="0" cellspacing="0">
		<tr>
			<td colspan="13" bgcolor="skyblue"><center><strong>Tabla CPU'S</strong></center></td>
		</tr>
		<tr>
...
<?php
 $sql = "SELECT * FROM cpus ORDER BY Departamento ASC";  
