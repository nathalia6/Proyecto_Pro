...
$query="INSERT INTO cpus(Codigo,Marca,Serie,Producto,Ram,Discoduro,Sistema,Arquitectura,Procesador,Macadd,Departamento,Puesto,Personal,Fecha,Veloci) VALUES('$Codigo','$Marca','$Serie','$Producto','$Ram','$Discoduro','$Sistema','$Arquitectura','$Procesador','$Macadd','$Departamento','$Puesto','$Personal')";
